if instance_number(Obj_PlayerManager) > 1 {instance_destroy()}
	...
	var spells = [new OffenseSpell(15, [], 5, 0, "Skull Bash", "Do big damage"),
				  new OffenseSpell(25, [], 15, 1, "Skull Bash II", "Do BIGGER damage")]
	characters[0] = new Player(25, 15, knightSprites[3], knightSprites, 0, noone, noone, spells, 5, 4, 5, 5, 
									"Knight", "A mysterious warrior from an era long gone")
	characters[1] = new Player(15, 25, slimeSprites[3], slimeSprites, 1, noone, noone, [], 5, 5, 5, 5, 
									"Slime", "Tired of working the grueling 9-5, this slime is looking for a more meaningful purpose")
	characters[2] = new Player(15, 25, walkSprites[3], walkSprites, 2, noone, noone, [], 5, 4, 5, 5, 
									"Dinosaur", "Has found its calling to life, which involves a lot of biting")
	characters[3] = new Player(1, 1, chives, [chives, chives, chives, chives], 3, noone, noone, [], 0, 0, 0, 0, 
